...
(function() {
  var Repository, assert, async, commitB, commitC, commitD, dataA, dataAHashes, dataB, dataBHashes, dataC, dataD, each, repo, testBranchA, testBranchB, testBranchC, testBranchD, testData, testTreeAncestors, _, _ref,
    __slice = [].slice;
