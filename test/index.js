...
(function() {
  var Repository, assert, async, commitB, commitC, commitD, dataA, dataAHashes, dataB, dataBHashes, dataC, dataD, difference, each, repo, testBranchA, testBranchB, testBranchC, testBranchD, testData, testTreeAncestors, _, _ref,
    __slice = [].slice;
  ...
  describe('branch', function() {
    ...
    return describe('paths', function() {
      return it('should return all tracked paths', function() {
        ...
        return assert.equal(difference(expected, testBranchC.paths()).length, 0);
      });
    });
  });
