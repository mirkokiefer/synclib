...
(function() {
  var Repository, TreeStore, assert, async, commitB, commitC, dataA, dataAHashes, dataB, dataC, each, readDataHashs, readParents, repo, testBranchA, testBranchB, testBranchC, testBranchD, testData, treeStore, _, _ref, _ref1;

  assert = require('assert');

  _ref = require('../lib/index'), Repository = _ref.Repository, TreeStore = _ref.TreeStore;
