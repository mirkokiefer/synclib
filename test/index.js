...
(function() {
  var Repository, assert, async, commitB, commitC, dataA, dataAHashes, dataB, dataBHashes, dataC, each, memoryStore, repo, store, testBranchA, testBranchB, testBranchC, testBranchD, testData, testTreeAncestors, _, _ref, _ref1,
    __slice = [].slice;
