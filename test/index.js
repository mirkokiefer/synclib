...
(function() {
  var Repository, assert, async, commitB, commitC, commitD, dataA, dataAHashes, dataB, dataBHashes, dataC, dataD, difference, each, keys, pluck, repo, testBranchA, testBranchB, testBranchC, testBranchD, testData, testTreeAncestors, _, _ref,
    __slice = [].slice;
  ...
  difference = _.difference, keys = _.keys, pluck = _.pluck;
