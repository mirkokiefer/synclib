...
(function() {
  var Repository, assert, async, commitB, commitC, commitD, dataA, dataAHashes, dataB, dataBHashes, dataC, dataD, each, memoryStore, repo, store, testBranchA, testBranchB, testBranchC, testBranchD, testData, testTreeAncestors, _, _ref, _ref1,
    __slice = [].slice;
