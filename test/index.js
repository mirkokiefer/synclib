...
(function() {
  var Repository, assert, assertPathData, async, commitB, commitC, commitD, contains, crossCheck, dataA, dataAHashes, dataB, dataBHashes, dataC, dataD, difference, each, keys, pluck, repo, testBranchA, testBranchB, testBranchC, testBranchD, testData, testTreeAncestors, union, values, where, _, _ref,
    __slice = [].slice;
  ...
  describe('branch', function() {
    ...
    describe('merge', function() {
      ...
      it('should merge branchA into branchB', function() {
        ...
        return crossCheck(headTree.ancestors, [dataAHashes[2], oldHead]);
      });
