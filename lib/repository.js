...
(function() {
  var Branch, Queue, Repository, Tree, TreeStore, addKeyPrefix, allPaths, async, clone, commit, contains, contentAddressable, findCommonCommit, findDelta, findDeltaDiff, findDiffWithPaths, groupCurrentAndChildTreeData, intersection, keyValueStore, keys, mergeDiffs, mergingCommit, objectDiff, objectDiffObject, pluck, read, readTreeAtPath, treeAncestors, treesAncestors, union, values, _, _ref,
    __slice = [].slice;
  ...
  findCommonCommit = function(tree1Start, tree2Start, treeStore) {
