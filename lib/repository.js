...
(function() {
  var Branch, Commit, Queue, Repository, Store, Tree, addKeyPrefix, allPaths, async, clone, commit, contains, contentAddressable, findCommonCommit, findCommonCommitWithPaths, findDelta, findDeltaDiff, findDiffWithPaths, findWalkPath, groupCurrentAndChildTreeData, intersection, keyValueStore, keys, mergeDiffs, mergingCommit, objectDiff, objectDiffObject, pluck, read, readTreeAtPath, treeAncestors, union, values, _, _ref,
    __slice = [].slice;
  ...
  Repository = (function() {
    ...
    Repository.prototype.commit = function(oldCommitHash, data) {
      var ancestors, hash, newCommit, newTree, oldTree, parsedData, path;
