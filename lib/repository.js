...
(function() {
  var Branch, Repository, Tree, TreeStore, addKeyPrefix, async, clone, commit, findCommonCommit, findDiff, findDiffSince, findDiffWithPaths, intersection, keys, mergingCommit, objectDiff, objectDiffObject, read, readTreeAtPath, splitCurrentAndChildTreeData, treeParents, treesParents, union, values, _, _ref,
    __slice = [].slice;
