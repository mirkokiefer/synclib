...
(function() {
  var Branch, Repository, Tree, TreeStore, addKeyPrefix, async, clone, commit, contains, findCommonCommit, findDelta, findDeltaDiff, findDiffWithPaths, intersection, keys, mergeDiffs, mergingCommit, objectDiff, objectDiffObject, pluck, read, readTreeAtPath, recurseUntilCommonCommit, splitCurrentAndChildTreeData, treeAncestors, treesAncestors, union, values, _, _ref,
    __slice = [].slice;
  ...
  Repository = (function() {
    ...
    Repository.prototype.deltaHashs = function(_arg) {
      ...
      for (_i = 0, _len = to.length; _i < _len; _i++) {
        ...
        diff = mergeDiffs(diff, findDelta(commonTree, eachTo, diff.trees, this.treeStore));
      }
      return diff;
    };
