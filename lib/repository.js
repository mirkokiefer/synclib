...
(function() {
  var Branch, Repository, Tree, TreeStore, addKeyPrefix, allPaths, async, clone, commit, contains, contentAddressable, findCommonCommit, findDelta, findDeltaDiff, findDiffWithPaths, intersection, keyValueStore, keys, mergeDiffs, mergingCommit, objectDiff, objectDiffObject, pluck, read, readTreeAtPath, recurseUntilCommonCommit, splitCurrentAndChildTreeData, treeAncestors, treesAncestors, union, values, _, _ref,
    __slice = [].slice;
