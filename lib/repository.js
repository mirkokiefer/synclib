...
(function() {
  var Branch, Repository, Tree, TreeStore, addKeyPrefix, async, clone, commit, findCommonCommit, findDiff, findDiffSince, findDiffWithPaths, intersection, keys, mergeDiffs, mergingCommit, objectDiff, objectDiffObject, read, readTreeAtPath, recurseUntilCommonCommit, splitCurrentAndChildTreeData, treeAncestors, treesAncestors, union, values, _, _ref,
    __slice = [].slice;
  ...
  findDiffSince = function(commonTreeHash, toTreeHash, treeStore) {
    ...
    if (toTree.ancestors.length === 1) {
      return mergeDiffs(diff, findDiffSince(commonTreeHash, toTree.ancestors[0], treeStore));
  ...
  Repository = (function() {
    ...
    Repository.prototype.patchHashs = function(_arg) {
      ...
      for (_i = 0, _len = to.length; _i < _len; _i++) {
        ...
        diff = mergeDiffs(diff, findDiffSince(commonTree, eachTo, this.treeStore));
      }
      return diff;
    };
